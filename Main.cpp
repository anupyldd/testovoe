 ...
 * количество мест, назависимо от их важности.
 * 
 * Второй алгоритм учитывает важность и выбирает маршрут, который
 * позволяет посетить наиболее важные места.
 * 
 * Третий алгоритм вычисляет ценность каждого часа, затраченного на
 * посещение, и учитывает этот фактор.
 * 
 * -------------
 * 
 * Алгоритмы возвращают объекты класса Route, в котороых содержится
 * маршрут и перегрузка оператора << для простоты вывода.
 * 
 * В коде используется функционал C++20.
 * 
 * -------------
 * 
